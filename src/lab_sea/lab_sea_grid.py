...
for year in years:
    ...
    # for ax, data, cm, vmin, vmax, lab in zip(axes, [O2[year - years[0],:,:], ct[0].T], [cmo.dense, cmo.amp], [245, 0], [315, 60], ['', '$N_{obs}$']):
        ...
        cb.set_label(lab)
    fig.savefig(Path(f'../../figures/lab_sea/2023/temp_grid/gridded_0-200m_{boxsize}deg_{year}.png'), dpi=350, bbox_inches='tight')
...
fig.savefig(Path(f'../../figures/lab_sea/2023/temp_grid/gridded_0-200m_{boxsize}deg_delta_60bwr.png'), dpi=350, bbox_inches='tight')
